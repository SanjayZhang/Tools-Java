...
public class AES {
     ...
     */
    public static byte[] encrypt(byte[] data, byte[] password) throws NoSuchPaddingException, NoSuchAlgorithmException, BadPaddingException, IllegalBlockSizeException, InvalidKeyException, InvalidAlgorithmParameterException {
     ...
     * @throws InvalidKeyException
     */
    public static byte[] decrypt(byte[] data, byte[] password) throws NoSuchPaddingException, NoSuchAlgorithmException, BadPaddingException, IllegalBlockSizeException, InvalidKeyException, InvalidAlgorithmParameterException {
        Key key = generateSecretKeySpec(password);
        Cipher cipher = Cipher.getInstance(DEFAULT_CIPHER_ALGORITHM);
        //使用CBC模式，需要一个向量iv，可增加加密算法的强度
        if (DEFAULT_CIPHER_ALGORITHM.contains("CBC")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] bytes = encrypt(data.getBytes(), keyBytes);
